...
fetch = [
  ...
  ("COLLECTION_LOCATION", ("assembly_info", "biosample", "attributes"), {"name": "geographic location (region and locality)"}),
  ("COLLECTION_LOCATION", ("assembly_info", "biosample", "attributes"), {"name": "geographic location (country and/or sea)"}),
