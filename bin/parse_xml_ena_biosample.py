...
fetch = [
  ...
  ("COLLECTOR_PLACE", ["SAMPLE", "SAMPLE_ATTRIBUTES"], ("tag", ".//*[TAG='geographic location (region and locality)']//", "VALUE")),
  ("COLLECTOR_COUNTRY", ["SAMPLE", "SAMPLE_ATTRIBUTES"], ("tag", ".//*[TAG='geographic location (country and/or sea)']//", "VALUE")),
  ...
  ("COLLECTOR_LOCATION", ["SAMPLE", "SAMPLE_ATTRIBUTES"], ("tag", ".//*[TAG='geographic location (region and locality)']//", "VALUE")),
