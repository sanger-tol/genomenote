...
def parse_args(arg=None):
    ...
    parser.add_argument("--exclude_molecules", type=str, help="List of molecules to exclude from labelling", default=list())
    parser.add_argument("--background_colour", type=str, help="Background colour for the labelled image", default="white")
